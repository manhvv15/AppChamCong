...
namespace ChamCong365.TimeKeeping
{
    ...
    public partial class ucDuyetThietBiMoi : UserControl
    {
        ...
        int totalPage = 0;
        #endregion
        public ucDuyetThietBiMoi()
        {

            InitializeComponent();
            cboChonPhongBan.ItemsSource = ListRoom;
            ...
            dgvDuyetThietBi.ItemsSource = itemsSaffs;
            ...
            this.dgvDuyetThietBi.DataContext = view;
        ...
        private void lsvSelectCompaty_SelectionChanged(object sender, SelectionChangedEventArgs e)
        {
            ...
            bodSelectCompanyCollapsed.Visibility = Visibility.Collapsed;
            txbSelectCompany.Foreground = (Brush)bc.ConvertFrom("#474747");
