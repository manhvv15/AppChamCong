...
namespace ChamCong365.OOP.NhanVien.DeXuatCuaToi
{
    public class ChiTietDeXuat
    {
        ...
        {
            public string danh_sach_tai_san { get; set; }
            public int? so_luong_tai_san { get; set; }
            public string ly_do { get; set; }
        }
        ...
        {
            public List<NoiDung> noi_dung { get; set; }
            public string ly_do { get; set; }
        }
        ...
        {
            public int? bd_xe { get; set; }
            public int? end_xe { get; set; }
