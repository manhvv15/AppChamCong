...
namespace ChamCong365.Popup.ChamCong.CaiDatLichLamViec
{
    ...
    /// </summary>
    public partial class ucSaoChepLichLamViec : UserControl
    {
        List<String> itemsLich = new List<String>() { "Thứ 2 - Thứ 6", "Thứ 2 - Thứ 7", "Thứ 2 - CN" };
        MainWindow Main;
        BrushConverter bc = new BrushConverter();
        int month, year;
        public ucSaoChepLichLamViec(MainWindow main)
        {
            InitializeComponent();
            Main = main;
        ...
        private void ChonTatCaNhanVien_Checked(object sender, RoutedEventArgs e)
        {

        }

        private void ChonTatCaNhanVien_Unchecked(object sender, RoutedEventArgs e)
        {
