...
{
    public class PlanningAppointmentList
    {
    ...
    public class Data2
    {
        ...
        public List<Items2> data { get; set; }
    ...
    public class Items2
    {
        ...
        public string position_name
        {
            get
            {
                if(string.IsNullOrEmpty(_position_name))
        ...
        private string _old_position_name { get; set; }
        public string old_position_name
        {
            get
            {
                if (string.IsNullOrEmpty(_old_position_name))
                    return GetNamePositionApply(old_position_id);
                return _old_position_name;
            }
            set { _old_position_name = value;}
        }
        public string old_dep_id { get; set; }
        public string old_dep_name { get; set; }
        public string decision_id { get; set; }
        public string decision_name
        {
            get
            {
                return GetNameDecisionApply(decision_id);
            }
        }
        ...
        private string GetNameDecisionApply(string decision_apply)
        {
            switch (decision_apply)
            {
                case "1":
                    return "Quy định bổ ngiệm số 003/HHP-P1";
                case "2":
                    return "Quy định bổ ngiệm số 003/HHP-P2";
                default:
                    return "";
            }
        }
        ...
        public string old_organizeDetailName { get; set; }
        public int new_organizeDetailId { get; set; }
        public List<ListOrganizeDetailId> new_listOrganizeDetailId { get; set; }
        public string new_organizeDetailName { get; set; }
        public string new_positionName { get; set; }
        public int new_position_id { get; set; }
        public string old_positionName { get; set; }
        public int? old_organizeDetailId { get; set; }
        public List<ListOrganizeDetailId> old_listOrganizeDetailId { get; set; }
    }
}
