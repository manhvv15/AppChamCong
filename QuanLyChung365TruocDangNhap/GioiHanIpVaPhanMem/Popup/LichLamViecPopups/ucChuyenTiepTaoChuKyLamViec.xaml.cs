...
//using QuanLyChung365TruocDangNhap.ChamCongNew.OOP.ChamCong.CaiDatLichLamViec.QuanLyChung365TruocDangNhap.ChamCongCoBan.Entities.funcQuanLyCongTy;
...
namespace QuanLyChung365TruocDangNhap.GioiHanIpVaPhanMem.Popup.LichLamViecPopups
{
    ...
    public partial class ucChuyenTiepTaoChuKyLamViec : UserControl
    {
        ...
        public ucChuyenTiepTaoChuKyLamViec(frmMain main, string ten, string thang, int select, string date,
        ...
        private async void LưuLich(object sender, MouseButtonEventArgs e)
        {
            try
            {
                ...
                if (allow)
                {
                    ...
                    var request = new HttpRequestMessage(HttpMethod.Post, APIs.APIs.Add_calander_api);
