...
namespace QuanLyChung365TruocDangNhap.ChamCongNew.Entities.ManageRecuitmentEntities.ListCandidateEntities
{
    ...
    public class DataEntity2
    {
        ...
        public string salaryyyy { get; set; }
        public string resiredSalary { get; set; }
        ...
        public string cvFrom { get { return cv_from; } set { cv_from = value; } }
        ...
        public List<ListSkill> listSkill { get; set; }
