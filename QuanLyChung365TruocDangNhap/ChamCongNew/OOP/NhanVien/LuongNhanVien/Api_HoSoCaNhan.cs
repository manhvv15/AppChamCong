...
namespace QuanLyChung365TruocDangNhap.ChamCongNew.OOP.NhanVien.LuongNhanVien
{
    ...
    public class Data_HoSoNhanVien
    {
    ...
    public class LichSuDieuChinhLuong
    {
        public int luong_cb 
        {
            get { return _luong_cb; }
            set { _luong_cb = value; }
        }
        private int _luong_cb;
        
        public string Luong_cb_Format
        {
            get { return luong_cb.ToString("N0"); }
            set 
            {
                if (int.TryParse(value.Replace(",", ""), out int parsedLuongdc))
                {
                    _luong_cb = parsedLuongdc;
                }
            }
        }
    ...
    public class Employee
    {
        ...
        public string time_quit_job { get; set; }
    ...
    public class InfoBasicSalary
    {
        ...
        public int sb_salary_basic 
        {
            get { return _sb_salary_basic; }
            set { _sb_salary_basic = value; }
        }

        private int _sb_salary_basic;

        public string LuongFormatted
        {
            get { return sb_salary_basic.ToString("N0"); }
            set
            {
                if (int.TryParse(value.Replace(",", ""), out int parsedLuong))
                {
                    _sb_salary_basic = parsedLuong;
                }
            }
        }
        ...
        public DateTime TimeApply
        {
            ...
            {
                DateTime aa;
                if (!string.IsNullOrEmpty(sb_time_up) && DateTime.TryParse(sb_time_up, out aa)) return aa;
        ...
        public string DateApply
        {
            get
            {
                var x = "";
                DateTime tt;
                if (!string.IsNullOrEmpty(sb_time_up) && DateTime.TryParse(sb_time_up, out tt))
                {
                    x = tt.ToString("dd-MM-yyyy");
                }
                return x;
            }
            set { sb_time_up = value; }
        }
    ...
    public class InfoContract
    {
        ...
        public DateTime TimeApplyHD
        {
            get
            {
                DateTime aa;
                if (!string.IsNullOrEmpty(con_time_up) && DateTime.TryParse(con_time_up, out aa)) return aa;
                return new DateTime(9999, 12, 30);
            }
        }
        public string DateApplyHD
        {
            get
            {
                var x = "";
                DateTime tt;
                if (!string.IsNullOrEmpty(con_time_up) && DateTime.TryParse(con_time_up, out tt))
                {
                    x = tt.ToString("dd-MM-yyyy");
                }
                return x;
            }
            set { con_time_up = value; }
        }
    ...
    public class Root_HoSoNhanVien
    {
        public Data_HoSoNhanVien data { get; set; }
