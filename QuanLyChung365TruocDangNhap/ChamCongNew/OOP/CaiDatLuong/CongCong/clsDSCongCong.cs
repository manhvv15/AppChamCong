...
namespace QuanLyChung365TruocDangNhap.ChamCongNew.OOP.CaiDatLuong.CongCong
{
    public class clsDSCongCong
    {
        ...
        public class BoNhiem
        {
            ...
            public string chucvu_hientai { get; set; }
        ...
        public class ListDexuat
        {
            ...
            public string time_xacnhan_cong { get; set; }
            public string ngay_xacnhan_cong { get; set; }
            public string nguoi_xet_duyet_format { get; set; }
