...
namespace QuanLyChung365TruocDangNhap.ChamCongNew.OOP.CaiDatLuong.BaoHiem
{
    public class clsNSuDaThietLap
    {
        ...
        public class ListU
        {
            ...
            public string Display_cls_day
            {
                get
                {
                    return cls_day.ToString("dd-MM-yyyy");
                }
            }
            ...
            public string Display_cls_day_end
            {
                get
                {
                    if(cls_day_end <= new DateTime(1970, 1, 1, 0, 0, 0))
                    {
                        return "Chưa cập nhật";
                    }
                    return cls_day_end.ToString("dd-MM-yyyy");
                }
            }
            public long cls_salary { get; set; }
            public TinhluongListClass TinhluongListClass { get; set; }
            public object Tinhluong365SalaryBasic { get; set; }
            public TinhluongFormSalary TinhluongFormSalary { get; set; }
            public Detail Detail { get; set; }
            //public Salary salary { get; set; }
            //public int bh_money { get; set; }
