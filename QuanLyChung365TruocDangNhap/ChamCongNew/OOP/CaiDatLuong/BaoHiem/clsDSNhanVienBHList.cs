...
namespace QuanLyChung365TruocDangNhap.ChamCongNew.OOP.CaiDatLuong.BaoHiem
{
    public class clsDSNhanVienBHList
    {
        ...
        public class ListUserFinal
        {
            ...
            public ClsDetail cls_detail { get; set; }
        }
        public class ClsDetail
        {
            ...
            public string Display_cls_day
            {
                get
                {
                    if(cls_day <= new DateTime(1970, 1, 1, 0, 0, 0))
                    {
                        return "Chưa cập nhật";
                    }
                    return this.cls_day.ToString("dd-MM-yyyy");
                }
            }
            ...
            public string Display_cls_day_end
            {
                get
                {
                    ...
                    return this.cls_day_end.ToString("dd-MM-yyyy");
                }
            }
            public int? cls_salary { get; set; }
            public string Display_cls_salary
            {
                get
                {
                    if (cls_salary != null)
                        return cls_salary.Value.ToString("N0") + " VNĐ";
                    else return "0 VNĐ";
                }
            }
