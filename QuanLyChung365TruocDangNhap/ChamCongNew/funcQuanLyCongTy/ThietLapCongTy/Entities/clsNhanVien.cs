...
namespace QuanLyChung365TruocDangNhap.ChamCongNew.ThietLapCongTy.Entities
{
    public class List_NhanVien
    {
        ...
        public string IDnName { get { if (ep_id == 0) return userName;
                return ep_id.ToString() + " - " + userName; } }
