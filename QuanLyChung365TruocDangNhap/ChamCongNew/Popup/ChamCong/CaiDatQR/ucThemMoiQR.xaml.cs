...
namespace QuanLyChung365TruocDangNhap.ChamCongNew.Popups.ChamCong.CaiDatQR
{
    ...
    /// </summary>
    public partial class ucThemMoiQR : UserControl
    {
        MainWindow Main;
        private ucListQR ucListQR;

        public ucThemMoiQR(MainWindow main, ucListQR ucListQR)
        {
            InitializeComponent();
        ...
        public async void AddQR()
        {
            try
            {
                var client = new HttpClient();
                var request = new HttpRequestMessage(HttpMethod.Post, "https://api.timviec365.vn/api/qlc/qrCode/create");
